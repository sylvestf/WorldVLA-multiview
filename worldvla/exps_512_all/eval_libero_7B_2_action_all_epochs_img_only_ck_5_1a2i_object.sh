...
data_config_train=../configs/libero_512_all/his_2_all_object_img_only_ck_5_1a2i.yaml
data_config_val_ind=../configs/libero_512_all/his_2_val_ind_object_img_only_ck_5_1a2i.yaml
data_config_val_ood=../configs/libero_512_all/his_2_val_ood_object_img_only_ck_5_1a2i.yaml
...
torchrun --nnodes=1 --nproc_per_node=1 --master_port=$((29502)) ../eval_solver_libero_512.py \
    --device 2 \
    --task_suite_name libero_object \
    --his 2h_1a_img_only \
    --no_auto_resume \
    --resume_path "../ckpts/chameleon/512_all/libero_object" \
    --eval_only True \
    --model_size 7B \
    --batch_size 4 \
    --accum_iter 1 \
