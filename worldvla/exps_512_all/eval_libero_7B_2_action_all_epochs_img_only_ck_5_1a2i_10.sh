...
base_exp_name=eval_libero_ts_10_his2imgonly_lr5e6_bs8_ck_10_1a2i_w004_all
base_output_dir=output_libero_512/"$base_exp_name"
mkdir -p "$base_output_dir"

torchrun --nnodes=1 --nproc_per_node=1 --master_port=$((29503)) ../eval_solver_libero_512.py \
    --device 3 \
    --task_suite_name libero_10 \
    --his 2h_1a_img_only \
    --no_auto_resume \
    --resume_path "../ckpts/chameleon/512_all/libero_10" \
    --eval_only True \
    --model_size 7B \
    --batch_size 4 \
    --accum_iter 1 \
